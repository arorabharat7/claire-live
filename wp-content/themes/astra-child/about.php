...
<section class="hero about">
    <div
        ...
        <img class="w-full lg:h-[27rem] md:h-64 h-56 object-cover"
            src="<?php echo $hero_banner_section_image['url']; ?>"
    ...
    <div class="container m-auto">
        ...
        <div class="grid grid-cols-12 gap-5 lg:my-8 md:my-6 my-4">
            ...
            <div class="md:col-span-8 col-span-12">
                <div
                    class="group relative hover:before:content-[''] hover:before:absolute hover:before:h-full hover:before:w-full hover:before:left-0 hover:before:top-0 hover:before:bg-[rgb(0,0,0,0.8)]  overflow-hidden before:content-[''] before:absolute before:h-full before:w-full before:left-0 before:top-0 before:bg-[rgb(0,0,0,0.15)]">
                    ...
                    <div
                        class="absolute top-2/4 left-2/4 -translate-x-2/4 -translate-y-2/4 lg:w-10/12 w-11/12 text-center duration-300 h-9 lg:group-hover:h-1/2  group-hover:h-3/5 overflow-hidden">
