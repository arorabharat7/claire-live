...
<section class="work-description lg:py-100 md:py-60 py-10">
    <div class="container m-auto">
        ...
        <div class="flex items-center gap-2 justify-center">
            <button class="py-3 md:px-9 group hover:bg-black rounded-none transition-all px-4 border border-i-primary lg:mt-2.5 mt-1.5"><a href="#" class="group-hover:brightness-[10] group-hover:text-white md:text-17 text-sm bg-no-repeat bg-right font-michroma ">Need help? </a></button>
            <button class="btn-arrow group hover:bg-white rounded-none transition-all border border-i-primary py-3 md:px-9 px-4  bg-black lg:mt-2.5 mt-1.5"><a href="#" class="group-hover:brightness-[0] group-hover:text-black md:text-17 text-sm bg-no-repeat bg-right brightness-[10] pr-7 font-michroma text-white">Contact us
                </a></button>
        </div>
    </div>
</section>
