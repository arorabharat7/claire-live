...
<section class="hero about">
    <div
        ...
        <img class="w-full md:h-64 h-56 object-cover" src="<?php echo $hero_banner_section_image['url']; ?>"
    ...
    <div class="container m-auto">
        ...
        <div class="grid grid-cols-12 gap-5 lg:my-8 md:my-6 my-4">
            ...
            <div class="md:col-span-8 col-span-12">
                <div
                    class="group main_box relative hover:before:content-[''] hover:before:absolute hover:before:h-full hover:before:w-full hover:before:left-0 hover:before:top-0 hover:before:bg-[rgb(0,0,0,0.8)]  overflow-hidden before:content-[''] before:absolute before:h-full before:w-full before:left-0 before:top-0 before:bg-[rgb(0,0,0,0.15)]">
                    <img src="<?php echo $how_we_work_first_column_image['url']; ?>"
                        width="<?php echo $how_we_work_first_column_image['width']; ?>"
                        height="<?php echo $how_we_work_first_column_image['height']; ?>"
                        alt="<?php echo $how_we_work_first_column_image['alt']; ?>"
                    ...
                    <div
                        class="alternate_heading absolute top-2/4 left-2/4 -translate-x-2/4 -translate-y-2/4 lg:w-10/12 w-11/12 text-center duration-300 h-9 lg:group-hover:h-1/2  group-hover:h-3/5 overflow-hidden">
            ...
            <div class="md:col-span-4 col-span-12">
                <div
                    class="main_box group relative hover:before:content-[''] hover:before:absolute hover:before:h-full hover:before:w-full hover:before:left-0 hover:before:top-0 hover:before:bg-[rgb(0,0,0,0.8)]   overflow-hidden before:content-[''] before:absolute before:h-full before:w-full before:left-0 before:top-0 before:bg-[rgb(0,0,0,0.15)]">
        ...
        <div class="swiper claire_team ">
            <div class="swiper-wrapper lg:mb-16 md:mb-14 mb-10">
                ...
                <div class="swiper-slide relative">
                    <img src="<?php echo $our_people_all_details_image['url']; ?>"
                        width="<?php echo $our_people_all_details_image['width']; ?>"
                        height="<?php echo $our_people_all_details_image['height']; ?>"
                        alt="<?php echo $our_people_all_details_image['alt']; ?>">
                    <div class="absolute left-5 bottom-5">
                        <h3 class="lg:text-xl font-michroma text-white uppercase"><?php echo $our_people_name; ?>
                        </h3>
                        <span
                            class="lg:text-17 font-semibold text-[#B1B1B1] lg:my-3 my-1 block"><?php echo $our_people_designation; ?></span>
        ...
        <div class="grid grid-cols-12 lg:gap-x-14 lg:gap-y-16 gap-7 md:gap-y-10  lg:mt-16 md:mt-10 mt-6">
            ...
            <div class="lg:col-span-3 md:col-span-6 col-span-12">
                ...
                <div class="text-center">
                    <img src="<?php echo $why_choose_us_section_all_details_image['url']; ?>"
                        width="<?php echo $why_choose_us_section_all_details_image['width']; ?>"
                        height="<?php echo $why_choose_us_section_all_details_image['height']; ?>"
                        alt="<?php echo $why_choose_us_section_all_details_image['alt']; ?>"
                        class="m-auto w-[80px] !h-[80px]">
        ...
        <div class="lg:mt-12 md:mt-10 mt-6">
            ...
            ?>
                <div class="md:col-span-2 col-span-5">
                    <img src="<?php echo $our_partners_section_images['url']; ?>"
                        width="<?php echo $our_partners_section_images['width']; ?>"
                        height="<?php echo $our_partners_section_images['height']; ?>"
                        alt="<?php echo $our_partners_section_images['alt']; ?>" class="m-auto">
                </div>
                <?php
                        $i++;
                    endwhile;
