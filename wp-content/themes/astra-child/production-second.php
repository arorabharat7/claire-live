              ...
              ?>
                  <?php if (!empty($production_manufacturing_first_sec_image)) { ?>
                    <div class="swiper-slide">
                      <img style="<?php echo $image_dimensions; ?>" src="<?php echo $production_manufacturing_first_sec_image['url']; ?>" width="801" height="580" alt="clair-service" class="w-full xl:h-[37rem] lg:h-[43rem] h-auto object-cover services-responsive object-cover">
                    </div>
              <?php }
              ...
              ?>
                  <?php if (!empty($production_manufacturing_first_sec_small_img)) { ?>
                    <div class="swiper-slide">
                      ...
                      <img style="<?php echo $image_dimensions; ?>" src="<?php echo $production_manufacturing_first_sec_small_img['url'] ?>" width="141" height="100" alt="clair-about-curtain" class="w-full  cursor-pointer services-responsive-small object-cover">
                    </div>
              <?php }
            ...
            <div class="swiper-wrapper">
              ...
              ?>
                  <?php if (!empty($production_manufacturing_second_sec_main_image)) { ?>
                    <div class="swiper-slide">
                      <img style="<?php echo $image_dimensions; ?>" src="<?php echo $production_manufacturing_second_sec_main_image['url']; ?>" width="801" height="580" alt="clair-service" class="w-full xl:h-[37rem] lg:h-[43rem] h-auto object-cover services-responsive object-cover">
                    </div>
              <?php }
              ...
              ?>
                  <?php if (!empty($production_manufacturing_second_sec_small_image)) { ?>
                    <div class="swiper-slide">
                      ...
                      <img style="<?php echo $image_dimensions; ?>" src="<?php echo $production_manufacturing_second_sec_small_image['url'] ?>" width="141" height="100" alt="clair-about-curtain" class="w-full  cursor-pointer services-responsive-small object-cover">
                    </div>
              <?php }
