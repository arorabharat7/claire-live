                    ...
                    <div class="swiper-wrapper ">
                        ...
                        ?>
                         <?php if(!empty($our_services_section_small_slider_details_images)){ ?>
                                <div class="swiper-slide">
                                    <img src="<?php echo $our_services_section_small_slider_details_images['url']; ?>" style="<?php echo $image_dimensions; ?>" width="141" height="100" alt="<?php echo $our_services_section_small_slider_details_images['alt']; ?>" class="w-full  cursor-pointer">
                                </div>
                        <?php }
