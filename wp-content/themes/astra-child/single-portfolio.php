...
<section class="hero">
    <div class="relative before:content-[''] before:absolute before:h-full before:w-full before:left-0 before:top-0 before:bg-[rgb(0,0,0,0.15)]">
        <?php if (!empty($image_url)) : ?>
            <img class="w-full  md:h-64 h-56 object-cover" src="<?php echo $image_url[0]; ?>" width="<?php echo $hero_banner_section_image['width']; ?>" height="<?php echo $hero_banner_section_image['height']; ?>" alt="<?php echo $hero_banner_section_image['alt']; ?>">
        <?php endif; ?>
...
?>
<section class="services lg:pt-24 md:pt-12 pt-6 bg-white">
        ...
        <div class="lg:grid lg:grid-cols-12 lg:gap-x-10 sm:p-8 p-3 border border-[#030303] items-center">
                    ...
                    <div class="swiper-wrapper ">
                        ...
                        ?>
                         <?php if(!empty($our_services_section_small_slider_details_images)){ ?>
                                <div class="swiper-slide">
                                    <img src="<?php echo $our_services_section_small_slider_details_images['url']; ?>" style="<?php echo $image_dimensions; ?>" width="141" height="100" alt="<?php echo $our_services_section_small_slider_details_images['alt']; ?>" class="w-full  cursor-pointer services-responsive-small object-cover">
                                </div>
                        <?php }
            ...
            <div class="xl:col-span-4 lg:col-span-5 ">
                ...
                <div class="flex justify-end items-center">
                    <!-- <button class="group rounded-none hover:bg-white transition-all btn-arrow bg-black py-3 lg:px-9 px-5 border border-black"><a href="<?php echo  $our_services_text_section_btn_url; ?>" class="group-hover:brightness-[0] group-hover:text-black lg:text-17 md:text-base text-sm  bg-no-repeat bg-right pr-7 font-michroma text-white brightness-[10]">
...
<section class="projects lg:py-12 md:py-10 py-6 bg-white">
    ...
    <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff" class="swiper claire-project ">
        <h2 class="lg:text-4xl md:text-3xl  text-2xl font-michroma text-black relative text-center uppercase after:content-[''] after:absolute after:w-24 after:h-[1px] after:bottom-0 lg:pb-6 pb-3 ">
            SIMILAR PROJECTS</h2>
